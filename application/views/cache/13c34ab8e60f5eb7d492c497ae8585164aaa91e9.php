	...
	<div class="row">
		...
		<div class="col-xs-12">
			...
			<div class="row event__border">
				<div class="col-6 col-br-l">
					<img src="<?php echo e(base_url('assets/template/br-top-l.png')); ?>" style="width:100%;height:100%">
				</div>
				<div class="col-6 col-br-r">
					<img src="<?php echo e(base_url('assets/template/br-top-r.png')); ?>" style="width:100%;height:100%">
				</div>
			</div>
		...
		<div class="col-xs-12">
			...
			<div class="event__akad" id="sec-event-akad">
				...
				<a href="<?php echo e($akadLoc); ?>" target="_blank" class="btn">
		...
		<div class="col-xs-12">
			...
			<div class="event__resepsi" id="sec-event-resepsi">
				...
				<a href="<?php echo e($resepsiLoc); ?>" target="_blank" class="btn">
					<span class="btn__inner btn_maps">Lihat Maps</span>
				</a>
		...
		<div class="col-xs-12">
			...
			<div class="row event__border">
				<div class="col-6 col-br-l">
					<img src="<?php echo e(base_url('assets/template/br-bot-l.png')); ?>" style="width:100%;height:100%">
				</div>
				<div class="col-6 col-br-r">
					<img src="<?php echo e(base_url('assets/template/br-bot-r.png')); ?>" style="width:100%;height:100%">
				</div>
			</div>
		</div>

	</div>
<?php /**PATH E:\xampp\htdocs\wedding\application\modules/Home/views/partial_detail/event.blade.php ENDPATH**/ ?>