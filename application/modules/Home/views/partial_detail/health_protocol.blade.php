    ...
    <div class="row health_protocol__row">
        <div class="col">
            {{-- <img src="{{ base_url('assets/templates/mark-l.png') }}" class="health_protocol__mark mark-l"> --}}
            <div class="health_protocol__title">
                Protokol Kesehatan
            </div>
            {{-- <img src="{{ base_url('assets/templates/mark-r.png') }}" class="health_protocol__mark mark-r"> --}}
        </div>
    </div>
